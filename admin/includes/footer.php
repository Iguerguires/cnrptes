      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <!-- <span>Copyright &copy; <a href="../../CNRPTES/home.php">CNRPTES</a> 2019</span> -->
            <div class="about">
              Pen by <a href="../../CNRPTES/home.php" target="_blank">CNRPTES</a> 
              <span class="one"></span> Follow me on: 
              <a href="" target="_blank">IGUERGUIRES.H</a> 
              <span class="two"></span> 
              <a href="" target="_blank">REMILAOUI.N</a>
            </div>
          </div>
        </div>
